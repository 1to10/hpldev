...
@section('page_heading',(isset($categoryByid))?'Update Sub Category':'Add Sub Category')
        ...
        <div class="row">
            <div class="col-sm-12">
                @component('admin.widgets.panel')
                    @slot('panelTitle', (isset($categoryByid))?'Update Sub Category':'Add Sub Category')
                    @slot('panelBody')
                          @if(isset($categoryByid))
                            {!! Form::model($categoryByid, [
                          'method' => 'POST',
                          'route' => ['sub.category.update', $categoryByid->id]
                      ]) !!}
                        @else
